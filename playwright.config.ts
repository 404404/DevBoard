...
const publicPort = Number.parseInt(process.env.LARK_TASKBOARD_PORT ?? "47823", 10);
...
export default defineConfig({
  ...
  webServer: [
    {
      command: "npm run build -w @lark-taskboard/contracts && npx tsx apps/server/src/main.ts",
